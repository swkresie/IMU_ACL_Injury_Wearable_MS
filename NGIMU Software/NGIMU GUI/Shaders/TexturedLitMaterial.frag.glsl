...
{	
	...
	vec4 overlayTexture = texture(sourceTexture, texture_uv_var); 	

	diffuseColor *= overlayTexture;
	...
	colorFrag.a *= mix(final_alpha, 1, overlayTexture.r); 

	//colorFrag = mix(colorFrag, overlayTexture, overlayTexture.a); 
